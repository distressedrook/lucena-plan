"""review_server — serves research/experiments/reports/ as static files (the
...
State file: research/experiments/reports/benchmark_review.json — plain JSON,
inspectable, git-diffable, safe to hand-edit. This script itself lives in
research/experiments/tools/ (2026-07-22 reorg) — DIR points at reports/ explicitly,
not at the script's own directory, since what's served is the generated
output, not the tool that generates it.

Run: python3 research/experiments/tools/review_server.py [port]   (default 8900)
"""
