...
A = "/Users/avismara/Development/lucena/lucena-plans/experiments/ev_positions.jsonl"
B = "/Users/avismara/Development/lucena/lucena-plans/experiments/ev_maia.jsonl"
OUT = "/Users/avismara/Development/lucena/lucena-plans/experiments/engine_vs_human_plans.jsonl"
...
if __name__ == "__main__":
    ...
    for r in pos:
        ...
        for leg in ("engine", "actual", "random"):
            row[leg] = sorted(labels(b, [chess.Move.from_uci(u) for u in r[leg]], 12, 2))
        row["maia"] = sorted(labels(
            b, [chess.Move.from_uci(u) for u in maia.get(r["n"], [])], 12, 2))
        rows.append(row)
