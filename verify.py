...
research harness rolls live via experiments/tools/rolls.py or reuses the
...
if __name__ == "__main__":
    ...
    # bank.json = {"pvs": [...], "rolls": [...]} (experiments/tools/rolls.py
    ...
    if len(sys.argv) > 4:
        ...
        sys.path.insert(0, os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "experiments", "tools"))
